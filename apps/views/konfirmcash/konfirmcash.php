        ...
        <div class="row">             
                ...
                <h3 class="box-title"> Cari Tagihan Mahasiswa</h3>
               ...
               <td>
                  ...
                  <span class="small"><em>*Wajib Dipilih</em></span>
                  </td>
        ...
        <div class="row">             
                ...
                <div class="box-header">
                <h3 class="box-title"> Data Tagihan Mahasiswa Belum dibayar</h3>
     ...
     $("#tampilmhs").html("<div align='center'><img src='<?php echo base_url();?>public/spinner.gif' width='50' height='50' align='center' /></div>");
       ...
       var nim               =jQuery("#nim").val();
        ...
        jQuery.ajax({
            ...
            url: '<?php echo base_url().$controller;?>/gettagihan', // File pemroses data
