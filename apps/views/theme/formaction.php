<script type="text/javascript" src="<?php echo base_url();?>assets/bootstrap/js/jquery.form.js"></script>
            <script>
                ...
                jQuery(document).ready(function() {                
                        ...
                        output.html("<div class='alert alert-warning'>Mengecek. . .</div>"); //update element with received data
                        ...
                        output.html("<div class='alert alert-warning'>Menyimpan. . .</div>"); //update element with received data
