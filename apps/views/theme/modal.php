...
<?php
        ...
        if($notif=="FailedDelete"){
          echo '          
          <script type="text/javascript">
          $(function() {
          $("#gagalhapus").modal("show");
          });
          </script>
          ';
        }
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content panel-success">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-check-circle"></i>  Sukses!</h4>
      </div>
     <div class="modal-body">
    Data Berhasil Disimpan !
        </div>
      <div class="modal-footer">
        <button type="reset"  class="btn btn-default" data-dismiss="modal"> <i class="fa fa-close"></i>
       Tutup</button>
      </div>
     </div>
...
<!-- Gaggal Modal -->
<div class="modal fade" id="gagalss" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content panel-danger">
      <div class="modal-header panel-danger">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-info-circle"></i> Gagal!</h4>
      </div>
    <div class="modal-body">
...
<div class="modal fade" id="confirm-hapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
       <h4 class="modal-title" id="myModalLabel"><i class="fa fa-info-circle"></i> Konfirmasi !</h4>
            </div>
            <div class="modal-body">
