...
<head>
  ...
  <link rel="stylesheet" href="<?php echo asset_url();?>plugins/pace/pace.min.css">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left image">
          <img src="<?php echo cdn_url();?>admin/<?php echo $_SESSION['image'];?>" class="img-circle" alt="User Image">
        </div>
