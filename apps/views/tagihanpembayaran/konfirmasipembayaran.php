            ...
            <input type="hidden" name="id_tagihan" id="id_tagihan" value="<?php echo $data['id_tagihan'];?>" >
                ...
                <br/>
                  ...
                  <div align="center">
                        ...
                        <a href="<?php echo base_url().$controller;?>/detailtransaksi/<?php echo $data['id_transaksi'];?>" class="btn btn-warning btn-lg"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
