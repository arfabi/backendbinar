...
<h3 class="box-title">Edit Setting Tagihan</h3>
</div>
<div class="box-body">
 ...
 <table class="table">
            ...
            <tr id="sks2" style="display: <?php if($data['id_kategori_pembayaran']!="2"){echo "none";}?>;">
                ...
                <br/>
                  ...
                  <div align="center">
                  <?php echo '
                      <a class="btn btn-primary btn-lg" href="'.base_url().$controller.'/editsetting/'.$data['id_setting_tagihan'].'"><i class="fa fa-sign-in"></i> Edit Setting</a> ';?>
                        

                        
                        <a href="<?php echo base_url().$controller;?>/detailsetting/<?php echo $data['id_setting_tagihan'];?>" class="btn btn-warning btn-lg"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
